    ...
    <Card v-if="showCreateDialog" class="p-4 md:p-6">
      ...
      <div v-else class="space-y-4">
        ...
        <div v-if="parsedPreview" class="space-y-3">
          ...
          <div class="flex gap-2">
            <Button variant="outline" size="sm" class="flex-1" @click="resetMarkdown">
              Voltar
            </Button>
...
// Inline markdown functions (for existing template)
...
async function confirmInlineImport() {
  ...
  try {
    // Update template comments/description if extracted
